...
CREATE SCHEMA IF NOT EXISTS DBT_PROJECT.TRAINING;

-- Create sales_india table
CREATE OR REPLACE TABLE DBT_PROJECT.TRAINING.sales_india (
  sales_date DATE,
  quantity_sold INT,
...
INSERT INTO DBT_PROJECT.TRAINING.sales_india (sales_date, quantity_sold, unit_sell_price, unit_purchase_cost) VALUES
...
CREATE OR REPLACE TABLE DBT_PROJECT.TRAINING.sales_uk (
  sales_date DATE,
  quantity_sold INT,
  unit_sell_price FLOAT,
  unit_purchase_cost FLOAT
...
INSERT INTO DBT_PROJECT.TRAINING.sales_uk (sales_date, quantity_sold, unit_sell_price, unit_purchase_cost) VALUES
('2025-06-01', 8, 120, 70),
('2025-06-02', 6, 130, 75),
...
CREATE OR REPLACE TABLE DBT_PROJECT.TRAINING.sales_us (
  sales_date DATE,
  quantity_sold INT,
  unit_sell_price FLOAT,
  unit_purchase_cost FLOAT
...
INSERT INTO DBT_PROJECT.TRAINING.sales_us (sales_date, quantity_sold, unit_sell_price, unit_purchase_cost) VALUES
